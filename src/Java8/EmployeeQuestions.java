...
public class EmployeeQuestions {
    ...
    public static void main(String[] args) {
        ...
        MaleFeMaleCount(employeeList);
        SortBasedOnSalary(employeeList);
    }
    ...
    public static void youngEmp(List<Employee> employeeList)
    {
    ...
    public static void SortBasedOnSalary(List<Employee> list)
    {
        List<Employee> collect = list.stream().sorted(Comparator.comparingDouble(Employee::getSalary)).collect(Collectors.toList());
        System.out.println(collect);
